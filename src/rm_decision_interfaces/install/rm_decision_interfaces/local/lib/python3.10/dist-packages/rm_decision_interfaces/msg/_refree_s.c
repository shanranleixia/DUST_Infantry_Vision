...
bool rm_decision_interfaces__msg__refree__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // robot_hp
    ...
    }
    {
      ...
      Py_ssize_t size = 16;
      uint16_t * dest = ros_message->robot_hp;
  ...
  {  // robot_status
    ...
    }
    {
      ...
      Py_ssize_t size = 16;
      uint8_t * dest = ros_message->robot_status;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * rm_decision_interfaces__msg__refree__convert_to_py(void * raw_ros_message)
{
  ...
  {  // robot_hp
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "robot_hp");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint16_t * src = &(ros_message->robot_hp[0]);
    memcpy(dst, src, 16 * sizeof(uint16_t));
    Py_DECREF(field);
  }
  {  // robot_status
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "robot_status");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint8_t * src = &(ros_message->robot_status[0]);
