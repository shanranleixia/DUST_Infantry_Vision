...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__TrackerInfo__rosidl_typesupport_introspection_c__TrackerInfo_message_member_array[2] = {
  {
    ...
    offsetof(auto_aim_interfaces__msg__TrackerInfo, is_tracking),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__TrackerInfo, tracking_score),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
