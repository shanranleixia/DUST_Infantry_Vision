...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__Measurement__rosidl_typesupport_introspection_c__Measurement_message_member_array[2] = {
  {
    "measurement",  // name
    ...
    offsetof(auto_aim_interfaces__msg__Measurement, measurement),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Measurement, timestamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auto_aim_interfaces, msg, Measurement)() {
  auto_aim_interfaces__msg__Measurement__rosidl_typesupport_introspection_c__Measurement_message_member_array[0].members_ =
